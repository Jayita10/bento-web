...
export default function Tag() {
    return (
        <DiscordMessages>
            ...
            <DiscordMessage timestamp='08/16/2021' profile='bentoBot'>
            <DiscordEmbed slot='embeds' color="#ffd903" authorName='All the Cappermotes' thumbnail='https://cdn.discordapp.com/avatars/232584569289703424/a_d38527440ed3d5cd3a8045862472ff99.gif?size=1024' authorImage='https://cdn.discordapp.com/icons/521080679606386698/882317d9d10df050ba1802546ce11775.png?size=1024' embedTitle='nav'>
